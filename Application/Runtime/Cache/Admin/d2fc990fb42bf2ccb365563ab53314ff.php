    ...
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'drug_id', width: 80, title: '药品编码',sort:true},
                {field: 'ins_code', width: 220, title: '国家药品代码'},
                {field: 'drug_name', width: 200, title: '国家库注册名称'},
                {field: 'drug_name', width: 200, title: '国家库商品名称'},
                {field: 'abbreviate_name', width: 135, title: '输入码'},
                {field: 'drug_form_name',width:135, title: '国家库注册剂型'},
                {field: 'drug_specification', width: 135, title: '国家库注册规格'},
                {field: 'baozhuang_type', width: 135, title: '国家库包装材质'},
                {field: 'src_unit_name', width: 135, title: '国家库最小包装单位'},
                {field: 'drug_producer_name', width: 250, title: '国家库药品企业'}
            ]],
            limit: 10,
            page: true,
            height:300,
