    ...
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'drug_name', width: 180, title: 'HIS国家药品代码'},
                {field: 'abbreviate_name', width: 120, title: 'HIS输入码'},
                {field: 'drug_form_name',width:135, title: 'HIS国家库注册剂型'},
                {field: 'drug_specification', width: 135, title: 'HIS国家库注册规格'},
                {field: 'baozhuang_type', width: 135, title: 'HIS国家库包装材质'},
                {field: 'src_unit_name', width: 200, title: 'HIS国家库最小包装单位'},
                {field: 'drug_producer_name', width: 250, title: 'HIS国家库药品企业'},
