...
<head>
    ...
    <link rel="stylesheet" href="/Public/css/layuimini.css?v=2.0.4.2" media="all">
    <link rel="stylesheet" href="/Public/css/themes/default.css" media="all">
    <link rel="stylesheet" href="/Public/lib/font-awesome-4.7.0/css/font-awesome.min.css" media="all">
    <!--[if lt IE 9]>
        ...
        <div class="layuimini-header-content">
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item layuimini-setting">
                    <a href="javascript:;"><?php echo $_SESSION['nickname'] ?></a>
...
<script>
    layui.use(['jquery', 'layer', 'miniAdmin','miniTongji'], function () {
        ...
        var options = {
            iniUrl: "/Public/api/init.json",    // 初始化接口
            clearUrl: "/Public/api/clear.json", // 缓存清理接口
